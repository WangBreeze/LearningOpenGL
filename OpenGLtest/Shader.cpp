...
Shader::Shader(const char *vertexPath, const char *fragmentPath)
{
    ...
    QFile vShaderFile((QString(vertexPath)));
    QFile fShaderFile((QString(fragmentPath)));
    // 保证ifstream对象可以抛出异常：
    ...
    {
        // 打开文件
        if (vShaderFile.open(QIODevice::ReadOnly) == false)
        {
            std::cout << "open file faild" << vShaderFile.fileName().toStdString() << std::endl;
        }
